...
?>
<div class="cart_totals <?php echo ( WC()->customer->has_calculated_shipping() ) ? 'calculated_shipping' : ''; ?> cart-summary-wrap">

	<?php do_action( 'woocommerce_before_cart_totals' ); ?>

	<h4><?php esc_html_e( 'Cart totals', 'woocommerce' ); ?></h4>
	<p><?php esc_html_e( 'Subtotal', 'woocommerce' ); ?> 
...
<!-- 		<tr class="order-total">
		...
		<h2><?php esc_html_e( 'Total', 'woocommerce' ); ?> 
...
<div class="wc-proceed-to-checkout cart-summary-button">
