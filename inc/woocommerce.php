 ...
 */
function raduga10_woocommerce_active_body_class( $classes ) {
	$classes[] = 'woocommerce-active';

	return $classes;
}
add_filter( 'body_class', 'raduga10_woocommerce_active_body_class' );
 ...
 */
function raduga10_woocommerce_related_products_args( $args ) {
	$defaults = array(
		'posts_per_page' => 3,
		'columns'        => 3,
	);
...
add_filter( 'woocommerce_output_related_products_args', 'raduga10_woocommerce_related_products_args' );
...
if ( ! function_exists( 'raduga10_woocommerce_wrapper_before' ) ) {
	/**
	 * Before Content.
	 *
...
add_action( 'woocommerce_before_main_content', 'raduga10_woocommerce_wrapper_before' );

if ( ! function_exists( 'raduga10_woocommerce_wrapper_after' ) ) {
	/**
	 * After Content.
	 *
	 ...
	 * @return void
	 */
	function raduga10_woocommerce_wrapper_after() {
		?>
			</main><!-- #main -->
		<?php
	}
}
add_action( 'woocommerce_after_main_content', 'raduga10_woocommerce_wrapper_after' );
